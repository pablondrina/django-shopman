  ...
  >
    ...
    <UiTooltip>
      <UiTooltipTrigger as-child>
        <span class="mb-1 grid size-10 cursor-default place-items-center rounded-md bg-primary-foreground/15" aria-label="Ponto de venda">
    ...
    <UiTooltip>
      <UiTooltipTrigger as-child>
        <button
          type="button"
          class="grid size-10 place-items-center rounded-md transition hover:bg-primary-foreground/10"
    ...
    <UiTooltip>
      <UiTooltipTrigger as-child>
        <button
          ...
          @click="emit('cash')"
        >
          <span class="grid size-7 place-items-center rounded-md" :class="hasOpenCashSession ? '' : 'ring-2 ring-primary-foreground/45'">
    ...
    <div class="mt-auto flex w-full flex-col items-center gap-0.5">
      ...
      <ClientOnly>
        ...
        <template #fallback>
          <span class="grid size-10 place-items-center rounded-md text-primary-foreground/80">
      ...
      <UiTooltip>
        <UiTooltipTrigger as-child>
          <button
            type="button"
            class="grid size-10 place-items-center rounded-md text-primary-foreground/80 transition hover:bg-primary-foreground/10 hover:text-primary-foreground disabled:opacity-50"

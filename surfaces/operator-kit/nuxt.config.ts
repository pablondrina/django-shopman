...
// aqui; a família operator-lock canônica (types/presentation/composable/overlay) já vive
// neste layer (o POS mantém a própria variante, usePosOperatorLock); a de-duplicação dos
// arquivos byte-idênticos (djangoProxy/tw-helper/translucent) segue nos WPs seguintes.

...
describe('surface UX guardrails', () => {
  ...
  it('keeps search on its own full page, menu only links to it', () => {
    ...
    // O cardápio não tem campo de busca próprio: a lupa navega para /busca.
    ...
    expect(menu).toContain(':to="buscaTarget"')
  ...
  it('renders the home hero as a canonical carousel without a tabbed landing panel', () => {
    ...
    expect(home).toContain('<section class="bg-muted pb-5 pt-0 sm:py-8 lg:py-10">')

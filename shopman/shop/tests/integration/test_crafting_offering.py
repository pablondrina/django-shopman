...
- Recipe references Offering products via output_sku (SKU)
- RecipeItem references ingredients via input_sku (SKU)
- Bundle/combo production

Covers:
- Recipe.output_sku -> Offering Product.sku
- RecipeItem.input_sku -> Offering Product.sku (ingredient)
"""
...
class TestRecipeProductRelationship:
    """Tests for Recipe referencing Offering Product via output_sku."""

    def test_recipe_output_sku_matches_product_sku(self, recipe, croissant):
        """Recipe output_sku should match Offering Product SKU."""
    ...
    def test_recipe_can_find_output_product(self, recipe, croissant):
        """Recipe output_sku can resolve to Offering Product."""
...
class TestRecipeIngredients:
    ...
    def test_recipe_item_references_product_by_sku(self, recipe, ingredient):
        """RecipeItem should reference Offering Product via input_sku."""

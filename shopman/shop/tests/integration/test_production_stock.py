"""
Integration tests: Craftsman <-> Stockman

Tests the production workflow integration:
- WorkOrder completion adds stock to Stockman
- Recipe ingredients can check/reserve Stockman inventory
...
class TestProductionOutputToStock:
    """Tests for adding production output to Stockman."""

    def test_complete_work_order_adds_stock(
        self, work_order, croissant, position_loja, today
    ):
        """Completing WorkOrder should add stock via Stockman."""
...
class TestIngredientAvailability:
    """Tests for checking ingredient availability via Stockman."""

...
class TestProductionWorkflow:
    ...
    def test_work_order_for_offerman_product(
    ...
    def test_work_order_completion_with_product(
        ...
        """Completing WorkOrder tracks production of Offerman product."""
...
class TestCatalogQueriesForProduction:
    """Tests for using Offerman catalog queries in production context."""

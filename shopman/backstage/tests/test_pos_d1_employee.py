...
class D1BadgePOSTests(TestCase):
    ...
    def test_product_with_d1_flag_renders_badge(self) -> None:
        ...
        from shopman.backstage.projections.pos import POSProductProjection
    ...
    def test_is_d1_flag_in_product_projection(self) -> None:
        ...
        with patch("shopman.backstage.projections._helpers._line_item_is_d1", return_value=True):

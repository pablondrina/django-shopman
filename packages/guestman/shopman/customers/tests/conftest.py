"""Pytest fixtures for Customers tests."""
...
def customer_preference(db, customer):
    """Create a customer preference (requires shopman.customers.contrib.preferences)."""
    if CustomerPreference is None:
        pytest.skip("CustomerPreference not available - install shopman.customers.contrib.preferences")
...
def customer_insight(db, customer):
    """Create a customer insight (requires shopman.customers.contrib.insights)."""
    if CustomerInsight is None:
        pytest.skip("CustomerInsight not available - install shopman.customers.contrib.insights")

...
from shopman.crafting.models import Recipe, RecipeItem, WorkOrder, WorkOrderEvent, WorkOrderItem


# Only register basic admin if Unfold contrib is NOT installed
if not apps.is_installed("shopman.crafting.contrib.admin_unfold"):

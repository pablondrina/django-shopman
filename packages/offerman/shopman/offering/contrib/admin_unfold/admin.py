...
class ListingAdmin(_ListingExportBase):
    from shopman.offering.contrib.admin_unfold.resources import ListingItemResource
...
class ProductAdmin(_ProductImportExportBase):
    from shopman.offering.contrib.admin_unfold.resources import ProductResource

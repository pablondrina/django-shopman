"""
Orderman contrib/refs — Localizadores e etiquetas externas.
...
Uso:
    from shopman.orderman.contrib.refs.services import attach_ref, resolve_ref, deactivate_refs
    from shopman.orderman.contrib.refs.types import POS_TABLE, PICKUP_TICKET
...
# Use: from shopman.orderman.contrib.refs.services import attach_ref
# Or: from shopman.orderman.contrib.refs.exceptions import RefError

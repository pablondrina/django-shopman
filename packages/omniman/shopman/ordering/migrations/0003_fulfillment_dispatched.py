...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("ordering", "0002_channel_listing_ref"),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="UPDATE ordering_fulfillment SET status = 'dispatched' WHERE status = 'shipped';",
            reverse_sql="UPDATE ordering_fulfillment SET status = 'shipped' WHERE status = 'dispatched';",
        ),
    ]

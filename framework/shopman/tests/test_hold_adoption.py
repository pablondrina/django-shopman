...
class TestReconcileSimple:
    ...
    @patch("shopman.services.availability._load_session_holds_for_sku")
    ...
    def test_reconcile_noop_when_already_at_target(
        ...
        from shopman.services.availability import reconcile
    ...
    @patch("shopman.services.availability._expand_if_bundle", return_value=None)
...
class TestCartReconcileIntegration:
    ...
    @patch("shopman.web.cart.ModifyService")
    @patch("shopman.web.cart.availability")
    ...
    def test_update_qty_shortage_raises_and_does_not_modify(
        ...
        from shopman.web.cart import CartService, CartUnavailableError

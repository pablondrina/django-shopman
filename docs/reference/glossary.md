...
| **ChannelConfig** | Dataclass com 9 aspectos de configuração de canal (confirmation, payment, fulfillment, stock, notifications, pricing, editing, rules, lifecycle). Cascata via `for_channel()`. |

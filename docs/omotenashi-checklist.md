...
| **checkout** | ✅ step machine Alpine, URL reflete step | ✅ contato sempre ✓, slots fechados ocultos, loyalty | ✅ steps progressivos, notas Padrão C | ✅ modal de nome, CHECKOUT_PHONE_PURPOSE, copy warm | ✅ summary lateral em tempo real |
...
| **login** | ✅ máscara de telefone automática | ✅ CHECKOUT_PHONE_PURPOSE, hero contextual por step | ✅ tela focada: só telefone ou OTP | ⚠️ "DDD inválido" / "Número longo demais" clínicos | ✅ fluxo rápido, SMS fallback |

...
- **Duplicacao de dataclasses:** `CustomerInfo` existe em `shopman.customer.protocols` e em `shopman.attending.protocols`. A interface e identica mas sao classes distintas

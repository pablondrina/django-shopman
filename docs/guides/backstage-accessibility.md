...
- Sync produção↔pedidos: progressbar em `pedidos/partials/detail.html` com `aria-valuenow/min/max`.

## Como Auditar Localmente

1. Rodar `python manage.py runserver`.
2. Abrir `/gestor/pos/`, `/gestor/kds/<ref>/`, `/gestor/pedidos/`, `/gestor/producao/`, `/gestor/fechamento/`.

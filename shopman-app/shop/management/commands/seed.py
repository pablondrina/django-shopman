...
class Command(BaseCommand):
    ...
    def _seed_channels(self):
        ...
        channels_data = [
            ...
            ("balcao", "Balcao / PDV", "internal", "open", "balcao", pos()),
            ("delivery", "Delivery Proprio", "internal", "open", "delivery", remote()),
            ("ifood", "iFood", "external", "locked", "ifood", marketplace()),
            ("whatsapp", "WhatsApp", "internal", "open", "web", remote()),
            ("web", "E-commerce", "internal", "open", "web", remote()),
        ]

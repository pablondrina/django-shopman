"""Gestor de Pedidos — operator dashboard for order management."""
...
def _enrich_order(order: Order) -> dict:
    ...
    if delivery_method == "delivery":
        fulfillment_type = "\U0001f697 Delivery"
    else:
        fulfillment_type = "\U0001f3ea Retirada"
...
class PedidoRejectView(View):
    """POST /pedidos/<ref>/reject/ — reject with mandatory reason."""

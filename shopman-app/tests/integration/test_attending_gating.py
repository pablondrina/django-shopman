"""
Integration test: Attending <-> Gating.
...
class TestAttendingGatingIntegration(TestCase):
    """Integration between Attending (customers) and Gating (auth)."""

    def setUp(self):
        from shopman.attending.models import Customer, ContactPoint
    ...
    def test_verified_contact_for_login(self):
        ...
        from shopman.attending.models import ContactPoint

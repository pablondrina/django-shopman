...
from shopman.customers.protocols.orders import OrderHistoryBackend, OrderSummary, OrderStats
...
class OrderingOrderHistoryBackend:
    ...
    Configuration in settings.py:
        GUESTMAN = {
            "ORDER_HISTORY_BACKEND": "shopman.customers.adapters.ordering.OrderingOrderHistoryBackend",
        }
    """

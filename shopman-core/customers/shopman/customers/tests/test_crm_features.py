...
from shopman.customers.models import Customer, CustomerGroup, CustomerAddress, ContactPoint
...
from shopman.customers.contrib.consent.models import CommunicationConsent, ConsentStatus
from shopman.customers.contrib.consent.service import ConsentService
from shopman.customers.contrib.loyalty.models import LoyaltyAccount, LoyaltyTransaction
...
class TestTransactionAtomicity:
    ...
    def test_add_address_is_default_atomic(self, customer):
        ...
        from shopman.customers.services import address as address_service

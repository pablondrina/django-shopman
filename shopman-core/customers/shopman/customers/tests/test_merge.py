...
from shopman.customers.contrib.merge.models import MergeAudit, MergeStatus
from shopman.customers.contrib.merge.service import MergeResult, MergeService
from shopman.customers.exceptions import CustomersError
from shopman.customers.gates import GateError
...
from shopman.customers.contrib.identifiers.models import CustomerIdentifier, IdentifierType
...
from shopman.customers.contrib.consent.models import (
    CommunicationConsent,
    ConsentChannel,
    ConsentStatus,
    LegalBasis,
)
from shopman.customers.contrib.loyalty.models import (
    LoyaltyAccount,
    LoyaltyTransaction,
    LoyaltyTier,
    TransactionType,
)
from shopman.customers.contrib.timeline.models import EventType, TimelineEvent

...
To use, add 'shopman.customers.contrib.admin_unfold' to INSTALLED_APPS after 'customers'.
...
class CustomerAdmin(BaseModelAdmin):
    ...
    def recalculate_insights(self, request, queryset):
        ...
        try:
            ...
            messages.error(request, _("customers.contrib.insights não está instalado."))
            return

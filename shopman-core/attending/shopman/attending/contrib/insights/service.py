...
from shopman.attending.protocols.orders import OrderHistoryBackend
...
def _get_order_backend() -> OrderHistoryBackend | None:
    ...
    attending_settings = getattr(settings, "ATTENDING", {})
    backend_path = attending_settings.get("ORDER_HISTORY_BACKEND")
    if backend_path:
...
class InsightService:
    ...
    def _calculate_recency_score(cls, days: int | None) -> int:
        ...
        from shopman.attending.contrib.insights.conf import get_recency_thresholds
    ...
    def _calculate_frequency_score(cls, orders: int) -> int:
        ...
        from shopman.attending.contrib.insights.conf import get_frequency_thresholds
    ...
    def _calculate_monetary_score(cls, total_q: int) -> int:
        ...
        from shopman.attending.contrib.insights.conf import get_monetary_thresholds

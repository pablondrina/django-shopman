"""
Attending Admin with Unfold theme.

This module provides Unfold-styled admin classes for Attending models.
To use, add 'guestman.contrib.admin_unfold' to INSTALLED_APPS after 'attending'.
...
class CustomerAdmin(BaseModelAdmin):
    ...
    def orders_link(self, obj):
        ...
        try:
            ...
            if count == 0:
                return "-"
            url = (
                reverse("admin:ordering_order_changelist")
    ...
    def recalculate_insights(self, request, queryset):
        ...
        try:
            ...
            messages.error(request, _("attending.contrib.insights não está instalado."))
            return

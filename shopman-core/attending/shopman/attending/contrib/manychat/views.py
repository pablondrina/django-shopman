...
Receives webhooks from Manychat and syncs subscribers to Attending.
...
from shopman.attending.gates import GateError, Gates

from .service import ManychatService

logger = logging.getLogger("attending.manychat")

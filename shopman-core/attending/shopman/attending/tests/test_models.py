...
class TestCustomerGroup:
    ...
    def test_create_group(self, db):
        ...
        group = CustomerGroup.objects.create(
            ref="atacado",
            name="Atacado",
            listing_code="atacado",
            priority=5,
        )
        assert group.ref == "atacado"
        assert group.listing_code == "atacado"
...
class TestCustomer:
    ...
    def test_listing_code_from_group(self, customer_vip, group_vip):
        """Test listing_code comes from group."""
        assert customer_vip.listing_code == "vip"
...
# See spec 005-attending.md for planned model.

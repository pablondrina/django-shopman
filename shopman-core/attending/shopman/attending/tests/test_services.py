...
# Contrib services
from shopman.attending.contrib.preferences import PreferenceService
from shopman.attending.contrib.insights import InsightService
from shopman.attending.contrib.identifiers import IdentifierService
...
class TestCustomerService:
    ...
    def test_get_listing_code(self, customer_vip):
        """Test getting listing code."""
        result = customer_service.get_listing_code("CUST-VIP")
        assert result == "vip"
...
class TestPreferenceService:
    ...
    def test_get_restrictions(self, customer, customer_preference):
        ...
        from shopman.attending.contrib.preferences.models import PreferenceType

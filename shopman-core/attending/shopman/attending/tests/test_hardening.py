...
from shopman.attending.gates import Gates, GateError
...
class TestProcessedEventCleanup:
    ...
    def test_create_processed_event(self, db):
        ...
        from shopman.attending.models import ProcessedEvent
...
class TestCleanupDryRun:
    """attending_cleanup --dry-run does not delete."""
    ...
    def test_dry_run_does_not_delete(self, db):
        ...
        out = StringIO()
        call_command("attending_cleanup", "--dry-run", "--days=90", stdout=out)

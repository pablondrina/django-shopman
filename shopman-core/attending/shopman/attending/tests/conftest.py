"""Pytest fixtures for Attending tests."""
...
def customer_preference(db, customer):
    """Create a customer preference (requires shopman.attending.contrib.preferences)."""
    if CustomerPreference is None:
        pytest.skip("CustomerPreference not available - install shopman.attending.contrib.preferences")
...
def customer_insight(db, customer):
    """Create a customer insight (requires shopman.attending.contrib.insights)."""
    if CustomerInsight is None:
        pytest.skip("CustomerInsight not available - install shopman.attending.contrib.insights")

...
logger = logging.getLogger("shopman.gating.magic_link")
...
class MagicLinkService:
    ...
    def send_magic_link(
        ...
        """
        if not get_gating_settings().MAGIC_LINK_ENABLED:
        ...
        ttl = gating_settings.MAGIC_LINK_TTL_MINUTES
    ...
    def _send_magic_link_email(
        ...
        try:
            ...
            text_body = render_to_string(
                gating_settings.TEMPLATE_MAGIC_LINK_EMAIL_TXT, context
            )
            html_body = render_to_string(
                gating_settings.TEMPLATE_MAGIC_LINK_EMAIL_HTML, context
            )

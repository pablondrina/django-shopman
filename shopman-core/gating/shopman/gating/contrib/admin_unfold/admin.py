...
This module provides Unfold-styled admin classes for Gating models.
To use, add 'doorman.contrib.admin_unfold' to INSTALLED_APPS after 'gating'.
...
from shopman.gating.models import BridgeToken, IdentityLink, MagicCode, TrustedDevice

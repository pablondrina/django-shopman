"""
Gating signals — Documented contracts (P6).
...
"""
Dispatched when a Customer successfully authenticates via Gating.

Kwargs:
    customer (GatingCustomerInfo): The authenticated customer.
...
Example::
    ...
    from shopman.gating.signals import customer_authenticated
...
Kwargs:
    ...
    customer (GatingCustomerInfo): The target customer.
...
Kwargs:
    ...
    customer (GatingCustomerInfo): The customer who verified.

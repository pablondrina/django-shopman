...
from shopman.offering.models import Collection, CollectionItem, Product, Listing, ListingItem
...
class TestCatalogExpand:
    ...
    def test_expand_bundle(self, db):
        ...
        from shopman.offering.models import ProductComponent
...
class TestCatalogSearchFilters:
    ...
    def test_search_query_and_collection(self, db):
        ...
        from shopman.offering.models import Collection, CollectionItem
...
class TestCatalogBackendAdapter:
    ...
    def test_get_price_fractional_rounding(self, db):
        ...
        with patch("shopman.offering.adapters.catalog_backend.CatalogService.price", return_value=1001):
...
class TestSuggestions:
    ...
    def test_find_alternatives_with_keywords(self, db):
        ...
        from shopman.offering.contrib.suggestions.suggestions import find_alternatives
        from shopman.offering.models import Collection, CollectionItem
    ...
    def test_find_similar_same_collection(self, db):
        ...
        from shopman.offering.contrib.suggestions.suggestions import find_similar
        from shopman.offering.models import Collection, CollectionItem

...
class TestCatalogBackendFractionalPrice:
    ...
    def test_500_divided_by_3_rounds_correctly(self):
        ...
        with patch("shopman.offering.adapters.catalog_backend.CatalogService.price", return_value=500):
            result = backend.get_price("ANY-SKU", qty=Decimal("3"))
    ...
    def test_qty_zero_returns_total(self):
        ...
        with patch("shopman.offering.adapters.catalog_backend.CatalogService.price", return_value=999):
    ...
    def test_exact_division(self):
        ...
        with patch("shopman.offering.adapters.catalog_backend.CatalogService.price", return_value=1000):
...
class TestProductMarginZeroPrice:
    ...
    def test_zero_price_with_cost_backend(self, product_zero_price):
        ...
        import shopman.offering.conf as conf

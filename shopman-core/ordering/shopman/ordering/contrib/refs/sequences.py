...
from shopman.ordering.contrib.refs.registry import get_ref_type
from shopman.ordering.contrib.refs.exceptions import RefTypeNotFound, RefScopeInvalid
...
def attach_sequence_ref(
    ...
    """
    from shopman.ordering.contrib.refs.services import attach_ref

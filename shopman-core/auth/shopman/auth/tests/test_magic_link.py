...
from shopman.auth.views.magic_link import MagicLinkRequestView
...
class TestMagicLinkService:
    ...
    @patch("shopman.auth.services.magic_link.MagicLinkService._send_magic_link_email")
    ...
    @override_settings(AUTH={"MAGIC_LINK_ENABLED": False})
    ...
    def test_send_magic_link_customer_inactive(self, mock_send, customer):
        ...
        with patch("shopman.auth.services.magic_link.get_customer_resolver") as mock_resolver:
...
class TestMagicLinkView:
    ...
    def test_get_renders_form(self):
        ...
        request = factory.get("/auth/magic-link/")

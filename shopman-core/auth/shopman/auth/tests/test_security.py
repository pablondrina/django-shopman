...
from shopman.auth.models.verification_code import generate_code, generate_raw_code, verify_code
...
from shopman.auth.views.access_link import AccessLinkCreateView, AccessLinkExchangeView
...
class TestOTPGeneration:
    ...
    def test_otp_uses_secrets_module(self):
        ...
        import shopman.auth.models.verification_code as vc_module
...
class TestAccessLinkLifecycle:
    ...
    def test_invalid_token_does_not_redirect(self):
        ...
        with patch("shopman.auth.views.access_link.render", return_value=None) as mock_render:
            view(request)
...
class TestPIILogging:
    ...
    def test_session_values_not_in_info_logs(self, customer, access_link):
        ...
        with patch("shopman.auth.services.access_link.logger") as mock_logger:

...
from shopman.crafting.services.scheduling import _check_rev, _next_seq
...
class CraftExecution:
    ...
    def close(cls, order, produced, consumed=None, wasted=None,
        ...
        """
        from shopman.crafting.models import WorkOrder, WorkOrderEvent, WorkOrderItem
    ...
    def _call_inventory_on_close(cls, order, requirements, produced_decimal):
        ...
        try:
            ...
            from shopman.crafting.protocols.inventory import MaterialProduced, MaterialUsed
